...
// TODO: 라이징 아티스트용 채팅 탭과 추천 탭 컴포넌트 생성 필요
// 현재는 임시 UI만 표시
const RisingChatTab = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <p className="text-sm text-gray-500 mb-2">라이징 아티스트 채팅</p>
      <p className="text-xs text-gray-400">API 연결 후 활성화됩니다</p>
    </div>
  );
};

const RisingRecommendTab = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <p className="text-sm text-gray-500 mb-2">추천 팬</p>
      <p className="text-xs text-gray-400">API 연결 후 활성화됩니다</p>
    </div>
  );
};
