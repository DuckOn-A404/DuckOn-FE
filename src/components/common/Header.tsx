          ...
          <nav className="px-2 py-3 space-y-1 text-sm">
            ...
            {isAdmin && (
              <button
                ...
                className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 hover:from-purple-100 hover:to-pink-100 active:scale-[0.98] transition-all"
              >
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 text-white flex items-center justify-center">
                  <Settings className="w-4 h-4" />
                </div>
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-purple-700">관리자 페이지</span>
